...
const manifests = [
  ...
  defineServiceAdapter({
    ...
    service: "analytics",
    source: "src/adapters/analytics/posthog.ts",
    runtime: "universal",
    packages: [],
  ...
  defineServiceAdapter({
    id: "analytics:ga4",
    service: "analytics",
    source: "src/adapters/analytics/ga4.ts",
    runtime: "universal",
    packages: [],
    env: ["GA4_MEASUREMENT_ID", "GA4_API_SECRET", "NEXT_PUBLIC_GA_ID"],
    bindings: [],
  }),
  defineServiceAdapter({
    id: "analytics:umami",
    service: "analytics",
    source: "src/adapters/analytics/umami.ts",
    runtime: "universal",
    packages: [],
    env: ["UMAMI_WEBSITE_ID", "UMAMI_API_KEY", "UMAMI_HOST"],
    bindings: [],
  }),
  defineServiceAdapter({
    id: "jobs:inngest",
