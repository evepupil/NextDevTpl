...
NextDevTpl ("us", "we", or "our") operates the NextDevTpl service (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.
...
By using NextDevTpl, you acknowledge that you have read and understood this Privacy Policy.
