...
The 3.x Worker target uses PostgreSQL through Neon HTTP or Hyperdrive. D1 is
outside the 3.x support scope. Generated Worker projects use a console logger
